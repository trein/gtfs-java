...
public class Transfer {
     ...
     * between the two stops, including buffer time to allow for schedule variance on each route. The
     * min_transfer_time value must be entered in seconds, and must be a non-negative integer.
     */
