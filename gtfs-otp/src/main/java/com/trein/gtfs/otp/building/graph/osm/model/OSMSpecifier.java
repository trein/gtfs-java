...
public class OSMSpecifier {
    ...
    public OSMSpecifier() {
        this.kvpairs = new ArrayList<P2<String>>(); // TODO string-pairs with a proper OSM tag class
    }
    ...
    public void setKvpairs(String spec) {
        ...
        for (String pair : pairs) {
            ...
            this.kvpairs.add(new P2<String>(kv[0], kv[1]));
        }
    }
    ...
    public P2<Integer> matchScores(OSMWithTags match) {
        ...
        for (P2<String> pair : this.kvpairs) {
        ...
        int allMatchLeftBonus = (leftMatches == this.kvpairs.size()) ? 10 : 0;
        leftScore += allMatchLeftBonus;
        int allMatchRightBonus = (rightMatches == this.kvpairs.size()) ? 10 : 0;
    ...
    public int matchScore(OSMWithTags match) {
        ...
        score += matches == this.kvpairs.size() ? 10 : 0;
        return score;
    }
    ...
    public void addTag(String key, String value) {
        this.kvpairs.add(new P2<String>(key, value));
    }
