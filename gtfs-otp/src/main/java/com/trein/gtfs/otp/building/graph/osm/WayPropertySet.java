...
import com.trein.gtfs.otp.building.graph.api.Alert;
...
public class WayPropertySet {
    ...
    public WayPropertySet() {
        /* sensible defaults */
        this.defaultProperties = new WayProperties();
        ...
        this.defaultSpeed = 11.2f; // 11.2 m/s ~= 25 mph ~= 40 kph, standard speed limit in the US
        ...
        // and edited
        this.maxSpeedPattern = Pattern.compile("^([0-9][\\.0-9]+?)(?:[ ]?(kmh|km/h|kmph|kph|mph|knots))?$");
    }
    
    public void setBase(WayPropertySetSource base) {
        this.base = base;
        WayPropertySet props = base.getWayPropertySet();
        this.creativeNamers = props.creativeNamers;
        this.defaultProperties = props.defaultProperties;
        this.notes = props.notes;
        this.slopeOverrides = props.slopeOverrides;
        this.wayProperties = props.wayProperties;
    }
    ...
    public WayProperties getDataForWay(OSMWithTags way) {
        ...
        result.setSafetyFeatures(new P2<Double>(rightResult.getSafetyFeatures().getFirst(), leftResult.getSafetyFeatures()
                .getSecond()));
    ...
    public float getCarSpeedForWay(OSMWithTags way, boolean back) {
        ...
        if ((speed != null) && (speed < 0.0001)) {
            LOG.warn("Zero or negative automobile speed detected at {} based on OSM " + "maxspeed tags; ignoring these tags",
                    this);
        }
    ...
    public boolean equals(Object o) {
        if (o instanceof WayPropertySet) {
            ...
            return (this.defaultProperties.equals(other.defaultProperties) && this.wayProperties.equals(other.wayProperties)
                    && this.creativeNamers.equals(other.creativeNamers) && this.slopeOverrides.equals(other.slopeOverrides) && this.notes
                        .equals(other.notes));
        }
        return false;
    }
    ...
    @Override
    public int hashCode() {
        return this.defaultProperties.hashCode() + this.wayProperties.hashCode() + this.creativeNamers.hashCode()
                + this.slopeOverrides.hashCode();
    }
    ...
    public Float getMetersSecondFromSpeed(String speed) {
        Matcher m = this.maxSpeedPattern.matcher(speed);
