 ...
 * states when working on a time-dependent graph. This approach is more coherent in Analyst when we
 * are extracting travel times from the optimal paths. It should also lead to less branching and
 * faster response times when building large shortest path trees. Note that for this SPT to work
 * properly, the work queue should be ordered by time rather than weight.
 *
 * @author andrewbyrd
 */
