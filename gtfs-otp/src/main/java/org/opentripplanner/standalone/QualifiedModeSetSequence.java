 ...
 * slashes meaning "or", or simply the word "or". This class and QualifiedMode are clearly somewhat
 * inefficient and allow nonsensical combinations like renting and parking a subway. They are not
 * intended for use in routing. Rather, they simply parse the language of mode specifications that
 * may be given in the mode query parameter. They are then converted into more efficient and useful
 * representation in the routing request.
 */
public class QualifiedModeSetSequence {
    ...
    public void applyToRequest(RoutingRequest req) {
        ...
        Set<QualifiedMode> qModes = this.sets.get(0);
