 ...
 * provides expression building methods which can be used via a static import. Thanks to Matt Might,
 * whose self-described "toy Java library" inspired the use of Java syntax to build up automata:
 * http://matt.might.net/articles/implementation-of-nfas-and-regular-expressions-in-java/ His
 * library also contained a comment suggesting the more functional style provided here by the
 * build() method.
 *
 * @author abyrd
 */
public abstract class Nonterminal {
     ...
     * times within a single expression. Because we allow epsilon moves in NFAs, every nonterminal
     * can have a single entry and exit point (i.e. start and accept state).
     *
