...
public class Leg {
    ...
    public Boolean isTransitLeg() {
        if (this.mode == null) {
            return null;
        } else if (this.mode.equals(TraverseMode.WALK.toString())) {
            return false;
        } else if (this.mode.equals(TraverseMode.CAR.toString())) {
            return false;
        } else if (this.mode.equals(TraverseMode.BICYCLE.toString())) {
            return false;
        } else if (this.mode.equals(TraverseMode.CUSTOM_MOTOR_VEHICLE.toString())) {
            return false;
        } else {
            return true;
        }
    ...
    public double getDuration() {
        return (this.endTime.getTimeInMillis() / 1000.0) - (this.startTime.getTimeInMillis() / 1000.0);
    }
