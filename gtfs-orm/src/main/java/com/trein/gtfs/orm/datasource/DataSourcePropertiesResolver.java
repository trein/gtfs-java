...
@Component
public class DataSourcePropertiesResolver {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(DataSourcePropertiesResolver.class);
