...
public class CSVUtil {
     ...
     * empty tokens created by adjacent separators. CSVUtil.split(null, *, true) = null
     * CSVUtil.split("", *, , true) = [] CSVUtil.split("a.b.c", '.', true) = ["a", "b", "c"]
     * CSVUtil.split("a...c", '.', true) = ["a", "", "", "c"] CSVUtil.split("a...c", '.', false) =
     * ["a", "c"]
     * 
     * @param str the string to parse
     * @param separatorChar the seperator char
     * @param preserveAllTokens if true, adjacent separators are treated as empty token separators
