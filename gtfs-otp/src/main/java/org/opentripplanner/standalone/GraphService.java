...
/**
 * A GraphService maps RouterIds to Graphs. The service interface allows us to decouple the
 * deserialization, loading, and management of the underlying graph objects from the classes that
 * need access to the objects. This indirection allows us to provide multiple graphs distringuished
 * by routerIds or to dynamically swap in new graphs if underlying data changes.
 */
public interface GraphService {
     ...
     * garbage collection. Routing will not be possible until new graphs are registered. This is
     * equivalent to calling evictGraph on every registered router ID.
     */
    public int evictAll();
