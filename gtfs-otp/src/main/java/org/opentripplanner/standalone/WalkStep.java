...
public class WalkStep {
    ...
    public void setDirections(double lastAngle, double thisAngle, boolean roundabout) {
        this.relativeDirection = getRelativeDirection(lastAngle, thisAngle, roundabout);
    ...
    public String streetNameNoParens() {
        int idx = this.streetName.indexOf('(');
        if (idx <= 0) { return this.streetName; }
        return this.streetName.substring(0, idx - 1);
    }
