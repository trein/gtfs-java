...
public class GtfsLibrary {
    ...
    public static final char ID_SEPARATOR = ':'; // note this is different than what OBA GTFS uses
                                                 // to match our 1.0 API
    ...
    /*
     * Using in index since we can't modify OBA libs and the colon in the expected separator in the
     * 1.0 API.
     */
    ...
    public static String getRouteName(Route route) {
        if (route.getShortName() != null) { return route.getShortName(); }
    ...
    public static TraverseMode getTraverseMode(Route route) {
        ...
        if ((routeType >= 100) && (routeType < 200)) { // Railway Service
            ...
            return TraverseMode.BUS;
                                                              ...
                                                              // Railway service
            return TraverseMode.RAIL;
        } else if ((routeType >= 500) && (routeType < 700)) { // Metro Service and Underground
                                                              // Service
    ...
    private static class GtfsContextImpl implements GtfsContext {
        ...
        private final CalendarService _calendar;
