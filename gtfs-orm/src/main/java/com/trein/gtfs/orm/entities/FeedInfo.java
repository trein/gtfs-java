...
public class FeedInfo {
     ...
     * capitalization rules and other language-specific settings for the feed. For an introduction to
     * IETF BCP 47, please refer to http://www.rfc-editor.org/rfc/bcp/bcp47.txt and
     ...
     * left empty if unavailable. The feed_end_date date must not precede the feed_start_date date if
     * both are given. Feed providers are encouraged to give schedule data outside this period to
     ...
     * assertion that there is no service for dates within the feed_start_date or feed_end_date range
